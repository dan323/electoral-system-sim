...
public class QuotasTest {
    ...
    private static List<Quota<String,Long>> quotas;
    ...
    private void oneRandomTest(Quota<String,Long> quotaUsed, Remainder<String> remainderUsed) {
    ...
    private void checkAssertions(Map<String, Long> votes, Map<String, Integer> solution, Quota<String,Long> quotaUsed, Remainder remainderUsed, int numOfSeats) {
    ...
    public void methodQuotaAllTest() {
        for (Quota<String,Long> quotaUsed : quotas) {
